    ...
    <div style={container}>
      ...
      <div
        style={{
          ...
          borderRadius: 15,
          background: "linear-gradient(20deg, #161616 0%, #323232 100%)",
          width: "fit-content",
        }}
      >
        {/* camada interna */}
        <div
          style={{
            padding: "8px 14px",
            borderRadius: 13,
            background: "linear-gradient(30deg, #090909 0%, #161616 50%",
          }}
        >
          <Text
            style={{
      ...
      >
        <div style={featureRow}>
          <img src="/icons/png/winking_face.png" style={{ height: 21 }} />
          <Text style={featureText}>{t("No filter, just authenticity")}</Text>
        </div>

        <div style={featureRow}>
          <img src="/icons/png/bell.png" style={{ height: 21 }} />
          <Text style={featureText}>{t("Interactions all the time")}</Text>
        </div>

        <div style={featureRow}>
          <img src="/icons/png/v_hand.png" style={{ height: 21 }} />
          <Text style={featureText}>{t("The vibe that matches")}</Text>
        </div>
      </div>
